...
class ExportViewController: UIViewController, ARSessionDelegate {
    ...
    @IBAction func tappedExportButton(_ sender: UIButton) {
        performSegue(withIdentifier: "goToProcessStoryboard", sender: self)
    }
    
//    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
//        if segue.identifier == "goToProcessVC" {
//            guard let vc = segue.destination as? ProcessViewController else { return }
//        }
//    }
